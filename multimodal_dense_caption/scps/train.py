...
def main(argv=None):
    ...
    parser.add_argument(
        "--class_files", required=True, nargs="+",
    )
    parser.add_argument(
        "--dense_caps_files", required=True, nargs="+",
    )
    parser.add_argument(
        "--caption_files",
        required=True,
    ...
    #    args.caption_files[0],
    #    args.feature_files[0],
    #    args.class_files[0],
    #    args.dense_caps_files[0],
    #    args.batch_size,
    #)
    # dataloader_coco_val = dataset.COCODataLoader(
    #    args.caption_files[1],
    #    args.feature_files[1],
    #    args.class_files[1],
    #    args.dense_caps_files[1],
    #    args.batch_size,
    # )
    ...
    dataloader_multi30k_train = dataset.Multi30kDataLoader(
        args.caption_files[2],
        args.feature_files[2],
        args.class_files[2],
        args.dense_caps_files[2],
        args.batch_size,
    )
    dataloader_multi30k_val = dataset.Multi30kDataLoader(
        args.caption_files[3],
        args.feature_files[3],
        args.class_files[3],
        args.dense_caps_files[3],
        args.batch_size,
    )
