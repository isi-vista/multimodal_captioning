...
config = Dict()
config.exp_name = 'DBNet_ResNet34'
config.train_options = {
    # for train
    'resume_from': f'./output/{config.exp_name}/checkpoint/best.pth',  # 继续训练地址
...
config.model = {
    'type': "DetModel",
    'backbone': {"type": "ResNet", 'layers': 34, 'pretrained': True}, # ResNet or MobileNetV3
